...
export default function Scene({ children, cameraProps, controlsProps, enablePointerEvents = false, showClouds = true, showSkybox = true, enableShader = true, smokeAffectedEngines = [], turnedOffEngines = [] }) {
